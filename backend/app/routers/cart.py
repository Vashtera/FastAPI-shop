...
async def add_to_cart(
    ...
    updated_cart = await service.add_to_cart(user_id, item)
...
def update_cart(
    ...
    updated_cart = service.update_cart_item(user_id, item)
    return {'cart': updated_cart}
...
def remove_from_cart(
    ...
    updated_cart = service.delete_from_cart(user_id, product_id)
    return {'cart': updated_cart}